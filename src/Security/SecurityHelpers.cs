...
namespace trnsACT.Core.Security
{
    public static class SecurityHelpers
    {
        public static string CreateCode(int length = 6)
        {
            ...
            return Path.GetRandomFileName()  //Uses RNG to get alpha-numeric characters
                       .Replace(".", "")
                       .Substring(0, length)
                       .ToUpper();
        }

        public static string CreatePasswordHash(string unhashedPassword)
        {
            RandomNumberGenerator _rng = RandomNumberGenerator.Create();
            return Convert.ToBase64String(HashPassword(unhashedPassword, _rng));
        }
